                  ...
                  if (snapshot.hasData) {
                    return ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          if (snapshot.data[index]['profile'] != null &&
                              snapshot.data[index]['topics'] != null) {
                            if (snapshot.data[index]['profile']['photo'] ==
                                null) {
                              return _buildCard(
                                  snapshot.data[index]['id'],
                                  snapshot.data[index]['name'] ?? " ",
                                  snapshot.data[index]['topics']['category']
                                          ['name'] ??
                                      " ",
                              ...
                              return _buildCard(
                                  ...
                                  snapshot.data[index]['topics']['category']
                                      ...
                                      " ",
                                  "${snapshot.data[index]['rate']}",
                                  "${snapshot.data[index]['profile']['photo']}");
                            }
                          }
                        });
